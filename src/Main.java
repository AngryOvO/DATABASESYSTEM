    ...
    public static void main(String[] args) throws SQLException {
        ...
        try(Connection con = DriverManager.getConnection(url, username, password)) {
            ...
            else if(input.equalsIgnoreCase("2"))
            {
                ...
                System.out.println("팀번호\t\t팀이름\t\t감독\t\t지역\t\t시드번호");
                while(resultSet.next())
                {
                    ...
                    System.out.println(teamnum + "\t\t" + teamname + "\t\t" + headcoachname + "\t\t" + region + "\t\t" + seednum);
                }
                ...
                while (resultSet3.next())
                {
                    ...
                    int teamnum = resultSet3.getInt("teamnum");
                    System.out.printf("%-10s   %-15s   %-15s   %-10s   %-10s\n", playernum, nickname, position, region, teamnum);
                }
